		...
		<view class="w-picker-cnt" :class="{'show':showPicker}">
			<view class="w-picker-hd" @touchmove.stop.prevent catchtouchmove="true">
			  ...
			  <view class="w-picker-btn" :style="{'color':themeColor}" @tap="pickerConfirm">确定</view> -->
				...
				<view class="close-title">{{defaultTitle}}</view>
			    <view class="disCenter close-box" @tap="pickerCancel">
			...
			<view class="w-picker-view" v-if="mode=='date'||mode=='dateTime'||mode=='yearMonth'">
				<picker-view indicator-style="height: 80upx;fontSize:32upx;fontWeight:bold;" :value="pickVal" @change="bindChange">
					<picker-view-column>
			...
			<view class="btn-wraps">
				<view class="btns disCenter" @tap="pickerConfirm">
					确定
				</view>
			</view>
		</view>
...
<script>
	import {initPicker,initDays} from "@/common/time.js";
